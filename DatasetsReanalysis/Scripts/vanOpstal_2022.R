...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2022_Exp1.xlsx")
...
#Experiment  2 Small
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2022_Exp2.xlsx")

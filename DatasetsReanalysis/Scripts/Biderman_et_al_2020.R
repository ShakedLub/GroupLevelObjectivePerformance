...
#Experiment 1b
#read the data set 
data <- read_excel("./PapersAndDownloadedData/Biderman_et_al_2020/Post1bAllSubj.xlsx",col_names = FALSE)
...
data_check_acc <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/accuracy_dprime/E1b_acc_dprime.csv")
...
#read the data set 
data <- read_excel("./PapersAndDownloadedData/Biderman_et_al_2020/Post2AllSubj.xlsx",col_names = FALSE)
colnames(data)=c("Subject","Distance","Context","Resp13", "RT", "Vis")
...
data_check_acc <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/accuracy_dprime/E2_acc_dprime.csv")
...
#read the data set
data <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/E3b_Post.csv")
...
data_check_acc <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/accuracy_dprime/E3b_acc_dprime.csv")
...
#read the data set 
data <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/E7_Post.csv")
...
#check accuracy calculation
data_check_acc <- read.csv("./PapersAndDownloadedData/Biderman_et_al_2020/Experimental and analysis codes/AnalysesCodes/AnalysesCodes/Data/Summary_Matrices/accuracy_dprime/E7_acc_dprime.csv")
...
save(processed_data, file = "./Data/B_2020.RData")

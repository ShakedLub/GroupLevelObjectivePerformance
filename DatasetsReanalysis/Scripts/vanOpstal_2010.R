...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2010_Exp1.xlsx")
...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2010_Exp2.xlsx")
...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2010_Exp3.xlsx")

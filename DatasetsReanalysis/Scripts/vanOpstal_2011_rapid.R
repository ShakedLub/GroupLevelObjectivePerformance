...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2011_Exp1_rapid.xlsx")
...
#read the data set 
raw_data <- read_excel("./DatasetsReanalysis/Datasets/VanOpstal/VanOpstal2011_Exp2_rapid.xlsx")

...
#################################################exp 1
#read the data set 
data <- read_excel("./DatasetsReanalysis/Datasets/Skora/Skora_et_al_2020_exp_1/Full_long_incl.RT_02.07_100ms_CONTROL ONLY.xlsx")
...
#read the data set 
data <- read_excel("./DatasetsReanalysis/Datasets/Skora/Skora_et_al_2020_exp_2/unconscious delay conditioning_Feb2020_full data.xlsx")

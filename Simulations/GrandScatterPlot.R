...
if (optionImage==1) {
  ...
  ggsave('./Output/SimulationsResultMain.jpg',f1)
  #ggsave('./Output/plotGrandResultMain.svg',f1)
  ...
  ggsave('./Output/SimulationsBayesResultsSupp.jpg',f2)
  ...
  ggsave('./Output/SimulationsFreqResultSupp.jpg',f1)
  #ggsave('./Output/plotGrandResultSupp.svg',f1)
  ...
  ggsave('./Output/SimulationsGlobalNullSupp.jpg',f1)
  ...
  ggsave('./Output/SimulationsBayesUninformativeSupp.jpg',f1)
}
